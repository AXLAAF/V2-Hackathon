# Ejemplo de demostración para ChismeLLM (artefacto BENIGNO).
# Una librería de utilidades normal. Sirve como control: el tribunal
# debería dictaminar NO_MALICIOSO.
