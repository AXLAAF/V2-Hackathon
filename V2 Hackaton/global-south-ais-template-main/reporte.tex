...
Usamos LLMs como apoyo en la redacción, la estructura y el encuadre bibliográfico de este
informe. Además, los LLMs son el propio objeto de estudio: los agentes que debaten dentro
de HAZE son LLMs. Todas las afirmaciones técnicas y las referencias fueron verificadas de
forma independiente por los autores. Los valores cuantitativos de la Sección 4 están
pendientes de la corrida experimental completa; las tablas y figuras correspondientes
documentan el protocolo de evaluación y se completarán con resultados medidos y validados
mediante pruebas de significancia antes de cualquier afirmación cuantitativa.
